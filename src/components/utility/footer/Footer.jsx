...
const Footer = () => {
  return (
    <footer
      className={`pt-4 ${styles.main__footer}`}
      style={{
        background: "linear-gradient(to bottom, #1b2833, #202f3c, #22303b)",
        color: "#fff",
      }}
    >
          ...
          <Row className="justify-content-between align-items-center py-5">
            <Col md="6">
              <h2 className="fs-4 position-relative">
                <i className="fa-regular fa-paper-plane"></i> Sign Up for New
                Letters
              </h2>
            </Col>
            <Col md="6">
              <div className="position-relative">
                <input
                  ...
                  className={`w-100 rounded py-1 ps-2 border-0 ${styles.footer__input}`}
                />
                <button
                  type="text"
                  className={`rounded ${styles.footer__subscribe}`}
                >
                  subscribe
                </button>
              </div>
        ...
        <Container>
          <Row>
            <Col sm="6" md="4" lg="3" className="">
              <h4>Contact Us</h4>
              <p className="mt-3">
                Demo store <br /> No.1256 freedom, New York, 1111 <br /> United
                states
              </p>
              <p className="mt-3">+91-987654321</p>
              <p className="mt-3">Demo@Exapmle.com</p>
              <div
                className={`mt-3 pe-5 d-flex justify-content-between align-items-center ${styles.social__media}`}
              >
                <i
                  className={`fa-brands fa-twitter ${styles.footer__icons}`}
                ></i>
                <i
                  className={`fa-brands fa-facebook-f ${styles.footer__icons}`}
                ></i>
                <i
                  className={`fa-brands fa-linkedin-in ${styles.footer__icons}`}
                ></i>
                <i
                  className={`fa-brands fa-youtube ${styles.footer__icons}`}
                ></i>
              </div>
            </Col>
            ...
            <Col sm="12" md="6" lg="3" className="">
              <div className={styles.margin__top}>
                ...
                <div className={`mt-3 d-flex ${styles.download__app}`}>
                  <div
                    className={`d-flex justify-content-center align-items-center me-2 ${styles.footer__download}`}
                  >
                    <i className="fa-brands fa-google-play fs-4 me-2"></i>
                    <p className="fw-bold">
                      <span className="fw-normal">get it on</span> <br /> Google
                      Play
                    </p>
                  </div>
                  <div
                    className={`d-flex justify-content-center align-items-center ${styles.footer__download}`}
                  >
                    <i className="fa-brands fa-apple fs-3 me-2"></i>
                    <p className="fw-bold">
                      <span className="fw-normal">get it on</span> <br /> App
                      Store
                    </p>
                  </div>
                </div>
      ...
      <footer className="py-3">
        <Container>
          <Row className="justify-content-between align-items-center">
            <Col sm="12" md="6">
              <p>
                <i className="fa-regular fa-copyright"></i> 2023. Digtic Powerd
                by Shopify
              </p>
            </Col>
            <Col sm="12" md="6">
              <div
                className={`d-flex justify-content-end ${styles.footer__payment}`}
              >
